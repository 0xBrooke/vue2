    ...
    <div>
        ...
        >
            ...
            >
                ...
                <div class="info-list" @click="toGrant(index)">
                    <div class="ungrant-title">
                    ...
                    <p>
                        <span class="info-title-name">订单号：</span>
                        <span>{{ item.orderId }}</span>
                    </p>
                    <p>
                        <span class="info-title-name">贷款金额:</span>
    ...
    methods: {
        ...
        getRewardList() {
            ...
            const data = {
                ...
                sendStatus: '3', //待发放：3；失败：2；发放中：1；已发放：0；
