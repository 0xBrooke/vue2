        ...
        >
            ...
            >
                ...
                <div class="grant-info">
                    ...
                    <p>
                        <span class="grant-info-title">订单号：</span>
                        <span>{{ item.orderId }}</span>
                    </p>
                    <p>
                        <span class="grant-info-title">贷款金额:</span>
...
export default {
    ...
    mounted() {
        this.$refs.grant.addEventListener(
            'scroll',
    ...
    methods: {
        ...
        touchMove(e) {
            const scrollTop = this.$refs.grant.scrollTop;
            if (scrollTop < 1) {
        ...
        getRewardList() {
            ...
            const data = {
                ...
                sendStatus: '1', //待发放：3；失败：2；发放中：1；已发放：0；
